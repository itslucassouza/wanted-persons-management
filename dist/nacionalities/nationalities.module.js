...
const nacionalities_schema_1 = require("./nacionalities.schema");
let NationalitiesModule = class NationalitiesModule {
};
NationalitiesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: 'Nationality', schema: nacionalities_schema_1.NationalitySchema }]),
        ],
        controllers: [],
        providers: [nationalities_service_1.NationalityService],
        exports: [nationalities_service_1.NationalityService]
    })
], NationalitiesModule);
